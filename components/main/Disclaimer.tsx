        ...
        <div className="prose prose-lg max-w-none text-black">
          ...
          <section className="mb-8">
            ...
            <p className="text-black mb-4">
              The information on Recipes by Clare is for general informational
              and educational purposes only. We make no representations or
              warranties about the completeness, accuracy, reliability, or
              suitability of the recipes and information.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <div className="bg-red-100 p-4 rounded-lg border border-red-300 mb-4">
              <p className="text-red-800 font-medium">
                <strong>Important:</strong> Always use your own judgment when
                preparing food and follow proper food safety guidelines.
              </p>
            </div>
          ...
          <section className="mb-8">
            ...
            <p className="text-black mb-4">
              ...
              Always consult your physician regarding dietary concerns or
              medical conditions.
            </p>
          </section>
          ...
          <section className="mb-8">
            ...
            <p className="text-black">
              Questions about this disclaimer? Contact us through our contact
              page.
            </p>
          </section>
        </div>
